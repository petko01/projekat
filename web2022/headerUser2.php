    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 200px;">
                ...
                <li class="nav-item">
                    <button id="button-coaches2" class="nav-link">Coaches</button>
                </li>
                ...
                <li class="nav-item">
                    <button id="button-profile2" class="nav-link">Profile</button>
                </li>
                <li class="nav-item">
            ...
            <form class="d-flex" method="POST" action="index.php">
                <input class="form-control me-2" id="input-search" name="input-search" type="search" placeholder="Search" aria-label="Search">
                <button class="btn btn-outline-success" name="button-search" id="button-search" type="submit">Search</button>
            </form>
        </div>
    </div>
</nav>
