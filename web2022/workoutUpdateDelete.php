...
<head>
    <meta charset="UTF-8">
    <title></title>
    <link type="text/css" rel="stylesheet" href="workoutUpdateDelete2.css">
</head>
<body>
...
foreach ($query2 as $q2) {
    ...
    <table>
              <tr>
               ...
               <td class="column8"><a href="index.php?id='.$q2->id.'">Edit</a></td>
               <td class="column9"><a href="index.php?id2='.$q2->id.'">Delete</a></td>
               </tr>
               </table>
    ';
}
